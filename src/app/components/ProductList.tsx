...
const products = [
  {
    ...
    price: "$3.99",
    imageUrl: "https://wearenotmartha.com/wp-content/uploads/Lucky-Charms-Ice-Cream-Featured-500x500.jpg",
  ...
  },
  {
    ...
    price: "$5.99",
    imageUrl: "https://t3.ftcdn.net/jpg/09/55/60/38/360_F_955603897_gIAYlFW8Zkdr71P4BvGMl1aOuqWZ1Tgp.jpg",
    bgColor: "bg-gray-800",
  },
  {
    id: 3,
    ...
    price: "$6.49",
    imageUrl: "https://t3.ftcdn.net/jpg/10/12/86/50/360_F_1012865013_oRfMph9g1sEvuFXIKqX3tyninFerRKam.jpg",
    bgColor: "bg-lime-900",
  },
];
...
<svg className='absolute buttom-0 left-0 mb-8 scale-150 group-hover:scale-[1.65] transition-transform' viewBox='0 0 375 263' fill='none' style={{opacity: 0.1}}>
          ...
          <div className='relative px-6 pb-6 mt-6'>
            <span className='block opacity-75 text-lime-300 underline font-bold -mb-1'>{product.category}</span>


          {/* Text Section */}
          <div className="flex justify-between">
            <span className="block font-bold text-cyan-300 text-xl">{product.title}</span>
