...
const products = [
  {
    ...
    price: "$6.99",
    imageUrl: "https://www.galaxejuice.co.uk/cdn/shop/files/Firefly_neapolitan_ice_cream_27065_300x300.jpg?v=1728115011",
    bgColor: "bg-rose-400",
  },
  {
    id: 2,
    ...
    price: "$5.99",
    imageUrl: "https://img.freepik.com/premium-photo/delicious-fluffy-red-velvet-ice-cream-bowl_787273-5332.jpg",
    bgColor: "bg-gray-900",
  },
  {
    id: 3,
    ...
    price: "$4.99",
    imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTofFrlX5hSFFNtvQb8PoLWQ3C6deR5rTSTMA&s",
  ...
  return (
    <div className="p-1 flex shrink-0  flex-wrap items-center justify-center mb-6 gap-16">
      {products.map((product) => (
        ...
        >
<svg className='absolute buttom-0 left-0 mb-8 scale-150 group-hover:scale-[1.65] transition-transform' viewBox='0 0 375 263' fill='none' style={{opacity: 0.1}}>
            <rect x="150.52" y="152" height="152" width="152" rx="8" transform='rotate(-45 159.52 175)' fill='white'/>
          ...
          <div className='relative px-6 pb-6 mt-8'>
            <span className='block text-slate-100 font-bold underline opacity-75 mb-0'>{product.category}</span>


          {/* Text Section */}
          <div className="flex justify-between">
            <span className="block text-white font-semibold text-xl">{product.title}</span>
